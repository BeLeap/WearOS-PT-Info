...
fun PrivacyPolicy() {
    ...
    Scaffold(
        ...
        ScalingLazyColumn(
            ...
            item {
                Text(
                    text = "1. 개인정보의 처리 목적 (‘WearOS-PT-Info’’이하 ‘App’) 은(는) 개인정보를 처리하고 있지 않습니다.\n" +
                            "\n" +
                            "2. 개인정보 보호책임자 작성\n" +
                            ...
                            "\n" +
                            "3. 개인정보 처리방침 변경\n" +
                            "①이 개인정보처리방침은 시행일로부터 적용되며, 법령 및 방침에 따른 변경내용의 추가, 삭제 및 정정이 있는 경우에는 변경사항의 시행 7일 전부터 적절한 방식을 통하여 고지할 것입니다.\n"
                )
            }
        }
    }
